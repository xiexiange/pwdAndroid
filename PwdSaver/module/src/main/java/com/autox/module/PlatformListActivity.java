...
import static com.autox.module.Constant.CATEGORY_TYPE.GAME;
import static com.autox.module.Constant.CATEGORY_TYPE.MONEY;
import static com.autox.module.Constant.CATEGORY_TYPE.WEB;
...
//        context.startActivity(intent);
    ...
    private void initData() {
        ...
        switch (mType) {
            ...
            case MONEY:
                mTitle = "金融";
                result.add(new PlatformListItem("招商银行(暂不支持密码)", R.drawable.platform_icon_zhaoshang));
                result.add(new PlatformListItem("建设银行(暂不支持密码)", R.drawable.platform_icon_jianshe));
                result.add(new PlatformListItem("农业银行(暂不支持密码)", R.drawable.platform_icon_nongye));
                result.add(new PlatformListItem("中国银行(暂不支持密码)", R.drawable.platform_icon_zhongguo));
                result.add(new PlatformListItem("工商银行(暂不支持密码)", R.drawable.platform_icon_gongshang));
                result.add(new PlatformListItem("浦发银行(暂不支持密码)", R.drawable.platform_icon_pufa));
                result.add(new PlatformListItem("广发银行(暂不支持密码)", R.drawable.platform_icon_guangfa));
                result.add(new PlatformListItem("信用社(暂不支持密码)", R.drawable.platform_icon_xinyongshe));
                result.add(new PlatformListItem("邮政储蓄(暂不支持密码)", R.drawable.platform_icon_youzheng));
                result.add(new PlatformListItem("本地银行(暂不支持密码)", R.drawable.platform_icon_localbank));
                break;
            case GAME:
                mTitle = "游戏";
    ...
    private class RecyclerViewAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            final String platform = tmpItem.name();
    ...
    public static int getDrawableIdByName(String name) {
        ...
        result.put("招商银行(暂不支持密码)", R.drawable.platform_icon_zhaoshang);
        result.put("建设银行(暂不支持密码)", R.drawable.platform_icon_jianshe);
        result.put("农业银行(暂不支持密码)", R.drawable.platform_icon_nongye);
        result.put("中国银行(暂不支持密码)", R.drawable.platform_icon_zhongguo);
        result.put("工商银行(暂不支持密码)", R.drawable.platform_icon_gongshang);
        result.put("浦发银行(暂不支持密码)", R.drawable.platform_icon_pufa);
        result.put("广发银行(暂不支持密码)", R.drawable.platform_icon_guangfa);
        result.put("信用社(暂不支持密码)", R.drawable.platform_icon_xinyongshe);
        result.put("邮政储蓄(暂不支持密码)", R.drawable.platform_icon_youzheng);
        result.put("本地银行(暂不支持密码)", R.drawable.platform_icon_localbank);
